...
function Weather() {
  ...
  const apiKey = "6cbde8dc4d86a1582ab4950cc67609f0";
  ...
  useEffect(() => {
    axios(apiURL + `q=${city}&appid=${apiKey}&units=metric&lang=en`)
          ...
          <div className='row'>
            <div className='col-lg-8 col-md-12 p-5 pe-lg-0'>
              <div className={`${theme}Box`}>
                <div className='row'>
                  ...
                  <div className='col-lg-6 col-sm-12 float-center text-center pt-4 pb-3 '>
                    <label className='me-3' htmlFor='sehir'>Select City:</label>
                  ...
                  {temps.list &&
                    <>
                      ...
                      <div className='col-lg-4 col-sm-4 float-start'>
                        ...
                        <h6 className='fs-6  text-center'><span className='color1'>Feels Like: </span>{" " + Math.round(temps.list[0].main.feels_like) + "°"}</h6></div>
                    </>
                  }</div>
              </div>
                    ...
                    <>
                      <div className={`${theme}Box col-lg-3 flex-fill mb-3 mx-2 col-sm-3 p-4 d-flex align-items-center`}>
                        <div className='row d-flex align-items-center'>
                          <h3 className='col-7 fw-bold fs-4'><span className='color1 fw-light fs-6'>Visibility: </span><br />{Math.round((temps.list[0].visibility) / 1000) + " km"}</h3>
                          <div className='col-5'>
                      ...
                      <div className={`${theme}Box col-lg-3 flex-fill mb-3 mx-2 col-sm-3 p-4 d-flex align-items-center`}>
                        <div className='row d-flex align-items-center'>
                          <h3 className='col-7 fw-bold fs-4 '><span className='color1 fw-light fs-5'>Humidity: </span><br />{temps.list[0].main.humidity + "%"}</h3>
                          <div className='col-5'>
                      ...
                      <div className={`${theme}Box col-lg-3 flex-fill mb-3 mx-2 col-sm-3 p-4 d-flex align-items-center`}>
                        <div className='row d-flex align-items-center'>
                          <h3 className='col-7 fw-bold fs-4 '><span className='color1 fw-light fs-5'>Pressure: </span><br />{temps.list[0].main.pressure + " mb"}</h3>
                          <div className='col-5'>
              ...
              <div className={`${theme}Box mt-2`}>
                <div className='row mx-auto'>
                  <h3 className=' p-3 color1 text-uppercase fs-5 fw-bold text-center'>DAILY FORECAST</h3>
            ...
            <div className='col-lg-4 col-md-12 px-5 pt-md-5'>
              <div className={`${theme}Box row`}>
                <h3 className='p-4 color1 text-uppercase fs-5 fw-bold text-center'>5 DAYS FORECAST</h3>
